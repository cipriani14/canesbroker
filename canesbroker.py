                    ...
                    if not game_end:
                        ...
                        try:
                           current_period, home_sog, away_sog, home_powerplay, away_powerplay, time_remaining = nhl.fetch_live_stats(live_stats_link) 
                            ...
                            print("nhl.fetch_live_state error encountered")
                        ...
                        ret = client1.publish("canes_data/current_period", "0")
                        ret = client1.publish("canes_data/home_sog", "0")
                        ret = client1.publish("canes_data/away_sog", "0")
                        ret = client1.publish("canes_data/time_remaining", "0")
                        ret = client1.publish("canes_data/canes_score", "0")
                        ret = client1.publish("canes_data/home_score", "0")
                        ret = client1.publish("canes_data/away_score", "0")
